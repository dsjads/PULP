...
data_column = [VARCOP_RANK, VARCOP_SPACE, VARCOP_DISABLE_BPC_RANK, SBFL_RANK, SPACE]
rank_column = [VARCOP_RANK, VARCOP_TC_RANK, SBFL_TC_RANK, FB_TC_RANK, VARCOP_DISABLE_BPC_RANK, SBFL_RANK]
SBFL_METRIC_COL = 0
NUM_CASES_COL = 1
NUM_BUGS_COL = 2
VARCOP_RANK_COL = 3
